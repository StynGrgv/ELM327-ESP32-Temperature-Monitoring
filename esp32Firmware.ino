...
uint8_t Address[6] = { 0x00, 0x10, 0xcC, 0x4F, 0x36, 0x03 }; // your device's MAC.
...
void setup() {
  ...
  if (!ELM_PORT.connect(Address, 2, sec_mask, role)) {  // if you can't connect on chanel 2, try another.
...
int HexToDec(char* n) { //Convert 2 char hex number to int dec. Easiest way.
  ...
  switch (cA) {
    ...
    case 'F':
      ...
      break;
    default:
      dec += (cA - '0') * 16; // '0' -> 48, '1' -> 49, ..... , '9' -> 57 => '9' - '0' = 9
